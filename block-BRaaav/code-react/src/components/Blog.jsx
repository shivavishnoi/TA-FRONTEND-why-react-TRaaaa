        ...
        <div className="flex wrap">
          <article className="flex article flex-48">
            <div className="flex-40 font-0">
              <img
                ...
                src="public/assets/media/blog-image1.jpg"
                alt="Blog image 1"
              />
            </div>
          ...
          <article className="flex article flex-48">
            <div className="flex-40 font-0">
              <img
                className="flexible-img"
                src="public/assets/media/blog-image2.jpg"
                alt="Blog image 1"
              />
            </div>
          ...
          <article className="flex article flex-48">
            <div className="flex-40 font-0">
              <img
                className="flexible-img"
                src="public/assets/media/blog-image3.jpg"
                alt="Blog image 1"
              />
            </div>
          ...
          <article className="flex article flex-48">
            <div className="flex-40 font-0">
              <img
                className="flexible-img"
                src="public/assets/media/blog-image4.jpg"
                alt="Blog image 1"
              />
            </div>
